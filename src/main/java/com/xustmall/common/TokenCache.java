...
public class TokenCache {
    ...
    public static final String TOKEN_OREFIX = "token_";
    /**
     *     本地缓存   1000-->设置缓存的初始化容量  当超过maximumSize(缓存的最大容量)的时候,Guava的Cache会使用LRU(最少
     *     使用算法)算法.缓存的有效期是12个小时
     */
